namespace Client.World
{
    public enum WorldCommand : uint
    {
        ...
        CMSG_GUILD_INFO = 135,
        SMSG_GUILD_INFO = 136,
        CMSG_GUILD_ROSTER = 137, // this GUILD tab motd send empty 
        SMSG_GUILD_ROSTER = 138, // recieve data
        ...
        CMSG_HELLO_DADDY = 1311,
        SMSG_HELLO_SON = 1312,
        CMSG_CLIENT_TICKET_LIST = 1313,
        CMSG_CLIENT_TICKET_VIEW = 1314,
        CMSG_CLIENT_TICKET_ASSIGN = 1315,
        CMSG_CLIENT_TICKET_DELETE = 1316,
        CMSG_CLIENT_TICKET_COMMENT = 1317,
        CMSG_CLIENT_TICKET_RESPONSE = 1318,
        CMSG_CLIENT_TICKET_ESCALATE = 1319,
        CMSG_CLIENT_TICKET_COMPLETE = 1320,
        CMSG_CLIENT_MAIL_PLAYER = 1321,
        CMSG_CLIENT_GET_QUEST_STATUS = 1322,
        CMSG_CLIENT_GET_ACH_STATUS = 1323,
        CMSG_CLIENT_COMPLETE_QUEST = 1324,
        CMSG_CLIENT_COMPLETE_ACH = 1325,
        CMSG_CLIENT_ADD_ITEM = 1326,
        CMSG_CLIENT_REMOVE_ITEM = 1327,
        CMSG_CLIENT_HAS_ITEM = 1328,
        CMSG_CLIENT_PLR_IS_ONLINE = 1329,
        CMSG_CLIENT_BAN = 1330,
        CMSG_CLIENT_TB_BUTTON = 1331,
        CMSG_CLIENT_REVIVE = 1332,
        CMSG_CLIENT_TP_PLAYER = 1333,
        CMSG_CLIENT_DEL_FRIEND_BY_NAME = 1334,
        CMSG_CLIENT_IGNORE_NAME = 1335,
        CMSG_CLIENT_SIMPLE_FRIEND_LIST = 1336,
        SMSG_CLIENT_SIMPLE_FRIEND_LIST = 1337,
        SMSG_CLIENT_TICKET_DATA = 1338,
        SMSG_CLIENT_QUEST_STATUS = 1339,
        SMSG_CLIENT_ACH_STATUS = 1340,
        SMSG_CLIENT_COMPLETE_X_REPLY = 1341,
        SMSG_CLIENT_HAS_ITEM = 1342,
        SMSG_CLIENT_ONLINE_REPLY = 1343,
